using System.Text;
using static BlazorWATemplate.Shared.Enums;

namespace BlazorWATemplate.Server.MailGenerator
{
        ...
        public TemplateBuilder(Enums.EmailTemplate Template)
        {
            ...
            switch (Template)
            {
                ...
                case Enums.EmailTemplate.OrderConfirmation:
                    TemplateFilePath = Path.Combine(Environment.CurrentDirectory, @"MailGenerator\Templates\OrderConfirmation.html");
                    break;
